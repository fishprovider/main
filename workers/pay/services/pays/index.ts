import { destroy as destroyQueue, QueuePromise, start as startQueue } from '@fishbot/core/libs/queuePromise';
import { SourceType, TransactionStatus, TransactionType } from '@fishbot/utils/constants/pay';
