...
app.on('web-contents-created', (_, contents) => {
   ...
   *
   * Navigation exploits are quite common. If an attacker can convince the app to navigate
   ...
   * convince the app to create new windows,
   * frames, or other renderer processes with more privileges than they had before;
   * or with pages opened that they couldn't open before.
   ...
   *
   * Strip away preload scripts, disable Node.js integration, and ensure origins
