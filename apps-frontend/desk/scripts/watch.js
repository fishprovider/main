 ...
 * Needs to set up `VITE_DEV_SERVER_URL` environment variable
 * from {@link import('vite').ViteDevServer.resolvedUrls}
 */
 ...
 * @param {import('vite').ViteDevServer} watchServer Renderer watch server instance.
 * Required to access the web socket of the page. By sending the `full-reload` command
 * to the socket, it reloads the web page.
 */
