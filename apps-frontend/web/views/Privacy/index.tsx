  ...
  return (
    <ContentSection>
      <Stack py={50}>
        ...
        <Text>Last updated: October 31, 2022</Text>
        ...
        <Title size="h2">Interpretation</Title>
        ...
        <Title size="h2">Definitions</Title>
        <Text>
          ...
          <ul>
            ...
            <li>
              <Text>
                ...
                {' '}
                means the software program provided by the Company downloaded by You on any electronic device, named FishProvider
              </Text>
            </li>
            <li>
              <Text>
                ...
                {' '}
                (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to FishProvider, Sydney.
              </Text>
            </li>
            <li>
              <Text>
            ...
            <li>
              <Text>
                ...
                {' '}
                refers to: New South Wales,  Australia
              </Text>
            </li>
            <li>
              <Text>
            ...
            <li>
              <Text>
                ...
                {' '}
                refers to FishProvider, accessible from
                {' '}
                <a href="https://www.fishprovider.com" rel="external nofollow noopener noreferrer" target="_blank">https://www.fishprovider.com</a>
              </Text>
            </li>
            <li>
              <Text>
        ...
        <Title size="h2">Types of Data Collected</Title>
        <Title size="h3">Personal Data</Title>
        <Text>
        ...
        <Title size="h3">Usage Data</Title>
        ...
        <Title size="h3">Tracking Technologies and Cookies</Title>
        <Text>
        ...
        <Text>
          ...
          <ul>
            <li>
              <Text><strong>Necessary / Essential Cookies</strong></Text>
            ...
            <li>
              <Text><strong>Cookies Policy / Notice Acceptance Cookies</strong></Text>
            ...
            <li>
              <Text><strong>Functionality Cookies</strong></Text>
              <Text>Type: Persistent Cookies</Text>
              <Text>Administered by: Us</Text>
        ...
        <Title size="h2">Use of Your Personal Data</Title>
        <Text>
        ...
        <Title size="h2">Retention of Your Personal Data</Title>
        ...
        <Title size="h2">Transfer of Your Personal Data</Title>
        ...
        <Title size="h2">Delete Your Personal Data</Title>
        ...
        <Title size="h2">Disclosure of Your Personal Data</Title>
        <Title size="h3">Business Transactions</Title>
        ...
        <Title size="h3">Law enforcement</Title>
        ...
        <Title size="h3">Other legal requirements</Title>
        <Text>
        ...
        <Title size="h2">Security of Your Personal Data</Title>
        ...
        <Title size="h2">CCPA Privacy Rights (Do Not Sell My Personal Information)</Title>
        ...
        <Title size="h2">GDPR Data Protection Rights</Title>
        ...
        <Text>
          ...
          {' '}
          <a target="_blank" href="mailto:admin@fishprovider.com" rel="noreferrer">admin@fishprovider.com</a>
        </Text>
      </Stack>
    </ContentSection>
  );
