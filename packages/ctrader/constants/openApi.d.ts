...
declare enum CommissionType {
    USD_PER_MILLION_USD = 1,
    USD_PER_LOT = 2,
    PERCENTAGE_OF_VALUE = 3,
    QUOTE_CCY_PER_LOT = 4
}
declare enum MinCommissionType {
    CURRENCY = 1,
    QUOTE_CURRENCY = 2
}
declare enum SymbolDistanceType {
    SYMBOL_DISTANCE_IN_POINTS = 1,
    SYMBOL_DISTANCE_IN_PERCENTAGE = 2
}
declare enum TradingMode {
    ENABLED = 0,
    DISABLED_WITHOUT_PENDINGS_EXECUTION = 1,
    DISABLED_WITH_PENDINGS_EXECUTION = 2,
    CLOSE_ONLY_MODE = 3
}
declare enum SwapCalculationType {
    PIPS = 0,
    PERCENTAGE = 1
}
declare enum OrderTriggerMethod {
    TRADE = 1,
    OPPOSITE = 2,
    DOUBLE_TRADE = 3,
    DOUBLE_OPPOSITE = 4
...
declare enum TotalMarginCalculationType {
    MAX = 0,
    SUM = 1,
    NET = 2
}
...
declare enum ChangeBonusType {
    BONUS_DEPOSIT = 0,
    BONUS_WITHDRAW = 1
}
declare enum ChangeBalanceType {
    BALANCE_DEPOSIT = 0,
    BALANCE_WITHDRAW = 1,
...
declare enum LimitedRiskMarginCalculationStrategy {
    ACCORDING_TO_LEVERAGE = 0,
    ACCORDING_TO_GSL = 1,
    ACCORDING_TO_GSL_AND_LEVERAGE = 2
}
declare enum ClientPermissionScope {
    SCOPE_VIEW = 0,
    SCOPE_TRADE = 1
}
