...
import { isMarketClosed as isMarketClosedCTrader } from '@fishbot/ctrader/utils/validate';
import { isMarketClosed as isMarketClosedMetaTrader } from '@fishbot/metatrader/utils/validate';
