import { OrderType as OrderTypeCTrader, TradeSide } from '@fishbot/ctrader/constants/openApi';
import { ProviderPlatform, type ProviderType } from '@fishbot/utils/constants/account';
